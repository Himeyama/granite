...
!define PRODUCT_NAME "Granite"
!define INSTALL_DIR "$LOCALAPPDATA\granite" # インストール先
!define PUBLISH_DIR "dist\granite"
!define EXEC_FILE "granite.exe"
!define PRODUCT_PUBLISHER "ひかりの備忘録"
